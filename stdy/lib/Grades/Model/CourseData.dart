...
import 'package:study/DatabaseData.dart';

class CourseData  extends DatabaseManager{
  ...
  static final CourseData _singleton = new CourseData._internal();
